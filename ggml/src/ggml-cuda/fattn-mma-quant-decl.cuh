...
//
// Two declarations per K type, matching the generator: the symmetric pair keeps
// V as a template argument, and every mixed pair shares one runtime-V kernel per
// K type. So coverage of every ordered pair is linear in the number of native
// types rather than quadratic.
//
