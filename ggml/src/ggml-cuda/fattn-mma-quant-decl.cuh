...
extern DECL_FATTN_MMA_QUANT_CASE_SYMMETRIC(GGML_TYPE_Q4_0, 512, 512, 8, 8);
FATTN_MMA_QUANT_TIER_EXTRA(
    extern DECL_FATTN_MMA_QUANT_CASE_SYMMETRIC(GGML_TYPE_Q4_1, 512, 512, 8, 8);)
FATTN_MMA_QUANT_TIER_EXTRA(
    extern DECL_FATTN_MMA_QUANT_CASE_SYMMETRIC(GGML_TYPE_Q5_0, 512, 512, 8, 8);)
FATTN_MMA_QUANT_TIER_EXTRA(
    extern DECL_FATTN_MMA_QUANT_CASE_SYMMETRIC(GGML_TYPE_Q5_1, 512, 512, 8, 8);)
