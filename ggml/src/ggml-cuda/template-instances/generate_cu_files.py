...
FATTN_MMA_Q8_HEAD_SIZES = [64, 128, 256]

SOURCE_FATTN_MMA_Q8_START = """// This file has been autogenerated by generate_cu_files.py, do not edit manually.

#include "../fattn-mma-f16.cuh"

"""

SOURCE_FATTN_MMA_Q8_CASE = "DECL_FATTN_MMA_Q8_CASE({head_size}, {head_size}, {ncols1}, {ncols2});\n"
...
for ncols in [8, 16, 32, 64]:
    for ncols2 in [1, 2, 4, 8]:
        if ncols2 > ncols:
            continue
        ncols1 = ncols // ncols2
        with open(f"fattn-mma-q8-instance-ncols1_{ncols1}-ncols2_{ncols2}.cu", "w") as f:
            f.write(SOURCE_FATTN_MMA_Q8_START)
            for head_size in FATTN_MMA_Q8_HEAD_SIZES:
                f.write(SOURCE_FATTN_MMA_Q8_CASE.format(
