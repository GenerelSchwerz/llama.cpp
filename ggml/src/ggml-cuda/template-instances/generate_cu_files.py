...
# The quantized-native MMA route compiles every ordered K/V pair of the
# compiled types: whatever the F16-casting path accepts, the native path
# accepts too. 121 ordered pairs over the eleven types, 16 over the four of
# the default tier. See ggml_cuda_fattn_mma_quant_pair() in
# fattn-mma-quant.cuh, which is the predicate the dispatcher and the route
# gate ask; there is no band for this list to mirror.
