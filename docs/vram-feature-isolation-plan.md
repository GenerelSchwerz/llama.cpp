...
| W03: compact causal mask | PR 7 measured runtime head `222eec2e7c91296b5f9335389dcff0cfc8a08129` on main baseline `4b86269fdf001de44dd96e9c9ae26a9e25091cca` | Causal representation, explicit MMA bound lifetime, compiled capability/exactness coverage, and branch-owned isolated/current evidence. | Official local gates pass; PR remains unmerged pending pushed-head checks and review. |
...
- Use only the final PR 7 publication descended from measured runtime head
  `222eec2e7c91296b5f9335389dcff0cfc8a08129`; verify the pushed head and PR
  state immediately before composition.
- Preserve the evidence boundary: isolated c9 results remain historical for
  their named binaries, while the fresh `4b86269fd`/`222eec2e7` comparison owns
  official main-based exactness, PPL, performance, and resource readiness.
