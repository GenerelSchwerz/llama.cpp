...
- **Opt-in quantized-native CUDA FlashAttention**: an explicitly compiled MMA kernel family can consume supported same-type K/V caches (`q8_0`, `q4_0`, `q5_0`, `q6_0` by default; `q4_1`, `q5_1`, `q6_1`, `q3_0`, `q3_1`, `q2_0`, `q2_1` under `GGML_CUDA_FA_ALL_QUANTS`) without a transient F16 copy. See the [design, limits, and validation protocol](docs/quantized-native-flash-attention.md).
