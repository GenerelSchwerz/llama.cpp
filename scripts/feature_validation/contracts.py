"""Fail-closed manifest and command contracts for feature validation.

This module owns declarative validation policy. It neither captures provenance
nor executes study commands.
"""
...
from .artifacts import load_json, sha256_file
